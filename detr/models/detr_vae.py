...
class DETRVAE(nn.Module):
    def __init__(self, backbones, transformer, encoder, state_dim, action_dim,
        ...
        if use_fast_tokens:
            assert vocab_size is not None and max_token_len is not None
